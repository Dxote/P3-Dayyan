...
<div id="wrapper">
    ...
    <div class="sidebar-brand-icon">
        @if ($setting->path_logo)
                <img src="{{ asset('storage/' . $setting->path_logo) }}" alt="Logo" class="img-profile rounded-circle avatar font-weight-bold" style="max-width: 40px;">
        @else
            <i class="fas fa-laugh-wink"></i>
        @endif
    </div>
        <div class="sidebar-brand-text mx-3">{{ $setting->nama_perusahaan }}</div>
</a>
...
@if(auth()->user()->level == 'admin')
    ...
    <li class="nav-item {{ Nav::isRoute('basic.index') }}">
        ...
        @if(auth()->user()->level == 'admin' || auth()->user()->level == 'petugas')
        <li class="nav-item {{ Nav::isRoute('setting.index') }}">
    ...
    @if(Auth::user()->foto)
    <img src="{{ asset('storage/' . Auth::user()->foto) }}" class="rounded-circle avatar font-weight-bold" style="width: 40px; height: 40px;">
@else
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Yann 2024</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
